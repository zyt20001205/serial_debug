...
class DocumentWidget(QWidget):
    ...
    def document_gui(self) -> None:
        ...
        save_button.setStyleSheet("text-align: left; font-size: 32px; color: #4d5157;")
        ...
        save_as_button.setStyleSheet("text-align: left; font-size: 32px; color: #4d5157;")
        ...
        load_button.setStyleSheet("text-align: left; font-size: 32px; color: #4d5157;")
        ...
        exit_button.setStyleSheet("text-align: left; font-size: 32px; color: #4d5157;")
